...
class OrderController extends Controller
{
    ...
    public function newIndexAction(Request $request)
    {
        ...
        $query = Order::with(['many_cart.product:id,name,slug', 'user', 'couriers'])->orderby('id', 'DESC');
    ...
    public function update(Request $request, $id)
    {
        ...
        return to_route('manager.order.newmanage');
        // }
    ...
    public function deleteChecketorders(Request $request)
    {
        ...
        return to_route('manager.order.manage')->with($notification);
    }
    ...
    public function selected_status(Request $request)
    {
        ...
        foreach ($orders as $order) {
            ...
            $history->recordStatusChange($order, Auth::user(), $oldStatus, $status, 'manager.selected_status');
