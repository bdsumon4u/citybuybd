...
class PayrollController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('manager.pages.payroll.index', compact('payrolls'));
    }
    ...
    public function show($id)
    {
        ...
        return view('manager.pages.payroll.show', compact('payroll', 'holidayRanges', 'holidayDaysInMonth', 'attendances', 'advances', 'paySettings', 'orderStats'));
    }
    ...
    public function advances(Request $request)
    {
        ...
        return view('manager.pages.payroll.advances', compact('advances'));
    }
}
