                    ...
                    <div class="card-block pd-5" style="background-color: #e9ecef;border: 1px solid lightgrey;">
                        <div class="row pb-3">
                            <div class="col-md-1 mr-5">
                                <a href="{{ route('manager.courier.create')}}" class="btn btn-success ">Add courier</a>
                            </div>
                            ...
                            @foreach( $couriers as $courier )
                                <tr>
                                    ...
                                    <td class="action-button">
                                        ...
                                        <ul>
                                            <li><a href="{{route('manager.courier.edit', $courier->id)}}"><i class="fa-solid fa-pen-to-square tx-18"></i></a></li>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('manager.courier.destroy', $courier->id)}}" method="POST">
                                                            @csrf
