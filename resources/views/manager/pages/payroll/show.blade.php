                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-sm table-borderless">
                                ...
                                <tr class="border-top">
                                    <td>Base Salary</td>
                                    <td class="text-right">৳{{ number_format($payroll->base_salary ?? 0, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>Off-Day Bonus (1.5x)</td>
                                    <td class="text-right text-success">+ ৳{{ number_format($payroll->off_day_bonus ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>OVER Amount</td>
                                    <td class="text-right text-success">+
                                        ৳{{ number_format($payroll->overtime_amount ?? 0, 2) }}</td>
                                </tr>
                                <tr>
                                    <td>Hazira Bonus</td>
                                    <td class="text-right text-success">+
                                ...
                                <tr>
                                    <td>Late Fee</td>
                                    <td class="text-right text-danger">- ৳{{ number_format($payroll->late_deduction ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>Penalty</td>
                                    <td class="text-right text-danger">- ৳{{ number_format($payroll->penalty_amount ?? 0, 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>Advance Deduction</td>
                                    <td class="text-right text-danger">-
                                        ৳{{ number_format($payroll->advance_deduction ?? 0, 2) }}</td>
                                </tr>
                                <tr class="border-top font-weight-bold">
                                    <td>Net Salary</td>
                                    <td class="text-right">৳{{ number_format($payroll->net_salary ?? 0, 2) }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    @if(!empty($orderStats['created_by_user_count']) || !empty($orderStats['created_by_user_delivered']))
                        <div class="alert alert-light border mt-3 mb-0">
                            ...
                            You created <strong>{{ number_format($orderStats['created_by_user_count']) }}</strong> manual order(s) this month, of which <strong>{{ number_format($orderStats['created_by_user_delivered']) }}</strong> were delivered.
                        </div>
                    @endif
                </div>
            </div>
