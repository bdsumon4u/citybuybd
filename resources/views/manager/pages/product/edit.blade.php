            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card bd-0 pd-10 overflow-hidden">
                        <form action="{{ route('manager.product.update', $product->id)}}" enctype="multipart/form-data"  method="POST">
                            @csrf
                                            ...
                                            @foreach(App\Models\ProductAttribute::all() as $attribute)
                                                ...
                                                <div class="form-group col-md-3 col-12">
                                                    <input type="checkbox" name="atr[]" class="attribute_id" 
                                                        @if(!is_null($product->atr))  
                                             
                                                            @foreach(App\Models\ProductAttribute::whereIn('id',json_decode($product->atr))->get() as $b)
                                                            ...
                                                            <p class="mb-0">
                                                                <input type="checkbox"
                                                                           @foreach(App\Models\Atr_item::whereIn('id',json_decode($product->atr_item))->get() as $c)
                                                                               ...
                                                                               @if($c->id == $att_item->id) checked @endif
