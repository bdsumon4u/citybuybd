                ...
                <div id="collapseTwo" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                    <div class="card-block pd-5" style="background-color: #e9ecef;border: 1px solid lightgrey;">
                        <div class="row pb-3">
                            ...
                            <div class="col-md-4">
                                <input id="myInputProduct" type="text" class="form-control"
                            ...
                            <table class="table mg-b-0 table-bordered table-striped">
                                ...
                                <tbody id="myTableProduct">
                                    ...
                                    @foreach ($products as $product)
                                        <tr>
                                            <th scope="row">
                                                <input type="checkbox" name="ids[{{ $product->id }}]" class="checkBoxClass"
                                            ...
                                            <td>
                                                ...
                                                @elseif($product->status == 0)
                                                    <a href="#"
                                                        class="btn btn-sm btn-danger btn-block">Unpublished</a>
                                                @endif

                                            </td>
                                            <td>
                                                @if ($product->assignedEmployees->count() > 0)
                                                    <div class="btn-group" role="group">
                                                        @foreach ($product->assignedEmployees as $employee)
                                                            <span
                                                                class="badge badge-info mr-1">{{ $employee->name }}</span>
                                                        @endforeach
                                                    </div>
                                                @else
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a href="{{ route('manager.product.destroy', $product->id) }}"
