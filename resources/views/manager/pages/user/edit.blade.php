                        ...
                        <form action="{{ route('manager.user.update', $user->id) }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select name="role" required="required" class="form-control">
                                        ...
                                        <option value="3" @if ($user->role == 3) selected @endif>Employee
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" value="{{ $user->getRawOriginal('panel_start') }}"
                                        name="panel_start" class="form-control form-control-lg" placeholder="e.g. 09:00:00">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label class="font-weight-bold text-dark text-2">Panel End[optional]</label>
                                    <input type="text" value="{{ $user->getRawOriginal('panel_end') }}" name="panel_end"
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" value="{{ $user->getRawOriginal('order_start') }}"
                                        name="order_start" class="form-control form-control-lg" placeholder="e.g. 09:00:00">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label class="font-weight-bold text-dark text-2">Order End[optional]</label>
                                    <input type="text" value="{{ $user->getRawOriginal('order_end') }}" name="order_end"
                                        class="form-control form-control-lg" placeholder="e.g. 18:00:00">
                                </div>
                            </div>
