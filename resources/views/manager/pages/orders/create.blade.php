...
<style>
    ...
    <div class="br-pagebody">
        <form action="{{ route('manager.order.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-5">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <select name="manual_order_type" id="manual_order_type" class="form-control select2">
                                            ...
                                            @foreach (App\Models\ManualOrderType::active()->ordered()->get() as $type)
                                                <option value="{{ $type->name }}" @if(old('manual_order_type') == $type->name) selected @endif>
                                                    {{ $type->name }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row" style="padding: 6px 0;">
                                    ...
                                    <label for="sub_total" class="text-right col-md-2 col-form-label">Sub Total</label>
                                    <div class="col-md-4">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="order_note" id="order_note" class="form-control" placeholder="Order Note (You can select a pre-saved note above or type a custom note here)"></textarea>
                                    </div>
                                </div>
                                <script>
