                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            @if ($isLockedOrder)
                                                <p class="text-danger font-weight-bold">
                                                    {{ \App\Models\Order::STATUS_MAP[$order->status] ?? 'Locked' }}
                                                    (Locked)</p>
                                            ...
                                            @else
                                                <select name="status" class="form-control">
                                                    ...
                                                    <option value="17"
                                                        {{ $order->status == 17 ? 'selected' : '' }}>Printed Invoice
                                                    </option>
                                                    <option value="16"
                                                        {{ $order->status == 16 ? 'selected' : '' }}>Total Courier
                                                    </option>
                                                    <option value="6"
                                                        {{ $order->status == 6 ? 'selected' : '' }}>
                                                        Pending Payment</option>
                                                    <option value="7"
                                                        {{ $order->status == 7 ? 'selected' : '' }}>On
                                                        Delivery</option>
                                                    <option value="8"
                                                        {{ $order->status == 8 ? 'selected' : '' }}>No Response 1
                                                    </option>
                                                    <option value="9"
                                                        {{ $order->status == 9 ? 'selected' : '' }}>No Response 2
                                                    </option>
                                                    <option value="3"
                                                        {{ $order->status == 3 ? 'selected' : '' }}>On Hold</option>
                                                    <option value="11"
                                                        {{ $order->status == 11 ? 'selected' : '' }}>Courier Hold
                                                    </option>
                                                    <option value="4"
                                                        {{ $order->status == 4 ? 'selected' : '' }}>Cancel</option>
                                                    <option value="15"
                                                        {{ $order->status == 15 ? 'selected' : '' }}>Stock Out</option>
                                                    <option value="19"
                                                        {{ $order->status == 19 ? 'selected' : '' }}>Double</option>
                                                    <option value="14"
                                                        {{ $order->status == 14 ? 'selected' : '' }}>Paid Return
                                                    </option>
                                                    <option value="18"
                                                        {{ $order->status == 18 ? 'selected' : '' }}>Pending Return
                                                    </option>
                                                    <option value="12"
                                                        {{ $order->status == 12 ? 'selected' : '' }}>Return</option>
                                                    <option value="13"
                                                        {{ $order->status == 13 ? 'selected' : '' }}>Partial Delivery
                                                    </option>
                                                    <option value="5"
                                                        {{ $order->status == 5 ? 'selected' : 'disabled' }}>Delivery
                                                    </option>
                                                </select>
                                            @endif
                                        </div>
                                                        ...
                                                        @elseif(false)
                                                            <tr class="product_item_row fallback_row"
                                                                ...
                                                                <td class="total_price">
                                                                    <div class="line_total" id="unit_price-fallback">0
                                                                    </div>
                                                                    <input type="hidden"
        ...
        $(document).ready(function() {
            ...
            $('#courier_id').change(function() {
                ...
                $.get("/get-city/" + courier, function(data) {
                    ...
                    data.forEach(function(element) {
                        option += "<option value='" + element.id + "'>" + element.city +
                            "</option>";
                    });
                    $('#city_id').html(option);
            ...
            $('#city_id').change(function() {
                ...
                $.get("/get-zone/" + city, function(data) {
                    data = JSON.parse(data);
                    data.forEach(function(element) {
                        option += "<option value='" + element.id + "'>" + element.zone +
                            "</option>";
                    });
                    $('#zone_id').html(option);
