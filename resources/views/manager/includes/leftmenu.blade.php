    ...
    <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
            <a href="{{ route('manager.dashboard') }}"
                class="br-menu-link {{ Request::is('manager/dashboard*') ? 'active' : '' }}">
        ...
        <li class="br-menu-item">
            <a href="{{ route('manager.order.newmanage') }}"
                class="br-menu-link {{ Request::is('manager/order-management/*') ? 'active' : '' }}">
                <!-- <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i> -->
        ...
        <li class="br-menu-item">
            <a href="{{ route('manager.order.parcelHandover') }}"
                class="br-menu-link {{ Request::is('manager/order-management/parcel-handover*') ? 'active' : '' }}">
        ...
        <li class="br-menu-item">
            <a href="{{ route('manager.order.returnReceived') }}"
                class="br-menu-link {{ Request::is('manager/order-management/return-received*') ? 'active' : '' }}">
        ...
        <li class="br-menu-item">
            <a href="{{ route('manager.product.manage') }}"
                class="br-menu-link {{ Request::is('manager/product/*') ? 'active' : '' }}">
                <!-- <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i> -->
        ...
        <li class="br-menu-item">
            <a href="#"
                class="br-menu-link with-sub {{ Request::is('manager/courier/*') || Request::is('manager/city/*') || Request::is('manager/zone/*') ? 'active' : '' }}">
                <i class="fas fa fa-truck"></i>
                <span class="menu-item-label">Couriers</span>
            </a><!-- br-menu-link -->
            <ul class="br-menu-sub">
                <li class="sub-item"><a href="{{ route('manager.courier.manage') }}"
                        class="sub-link {{ Request::is('manager/courier/*') ? 'active' : '' }}">Courier</a></li>
                <li class="sub-item"><a href="{{ route('manager.city.manage') }}"
                        class="sub-link {{ Request::is('manager/city/*') ? 'active' : '' }}">City</a></li>
                <li class="sub-item"><a href="{{ route('manager.zone.manage') }}"
                        class="sub-link {{ route('manager.courier.manage') }}"
                        class="sub-link {{ Request::is('manager/zone/*') ? 'active' : '' }}">Zone</a></li>
        ...
        <li class="br-menu-item">
            <a href="{{ route('manager.user.manage') }}"
                class="br-menu-link {{ Request::is('manager/user/*') ? 'active' : '' }} ">
