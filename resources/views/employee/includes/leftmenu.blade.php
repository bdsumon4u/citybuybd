    ...
    <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
            <a href="{{ route('employee.dashboard') }}"
                class="br-menu-link {{ Request::is('employee/dashboard*') ? 'active' : '' }}">
        ...
        <li class="br-menu-item">
            <a href="{{ route('employee.order.newmanage') }}"
                class="br-menu-link {{ Request::is('employee/order-management/*') ? 'active' : '' }}">
        ...
        <li class="br-menu-item">
            <a href="{{ route('employee.order.parcelHandover') }}"
                class="br-menu-link {{ Request::is('employee/order-management/parcel-handover*') ? 'active' : '' }}">
        ...
        <li class="br-menu-item">
            <a href="{{ route('employee.order.returnReceived') }}"
                class="br-menu-link {{ Request::is('employee/order-management/return-received*') ? 'active' : '' }}">
