                    ...
                    <div class="card-block pd-5" style="background-color: #e9ecef;border: 1px solid lightgrey;">
                        <div class="row pb-3">
                            <div class="col-md-1 mr-5">
                                <a href="{{ route('childcategory.create')}}" class="btn btn-success ">Add childcategory</a>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="action-button">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="" data-toggle="modal" data-target="#delete{{$childcategory->id}}">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Are you sure to want to delete this childcategory?
                                                    </div>
