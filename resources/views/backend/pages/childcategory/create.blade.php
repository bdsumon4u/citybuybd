            		...
            		<div class="col-lg-12">
                        ...
                        <form action="{{ route('childcategory.store') }}" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" autocomplete="off" required="required" placeholder="Enter Category Name">
                            </div>
                            ...
                            <div class="form-group">
                                <input type="submit"  value="Add New Category" class="btn btn-teal btn-block mg-b-10">
                             </div>
