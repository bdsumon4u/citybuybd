            ...
            <div class="br-section-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="{{ route('childcategory.update', $childcategory->id)}}" enctype="multipart/form-data"  method="POST">
                            @csrf
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" autocomplete="off" required="required" value="{{ $childcategory->title}}" placeholder="Enter childcategory Name">
                            </div>
                                        ...
                                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                            <select name="category_id" id="category_id" required="required" class="form-control">
                                                ...
                                                @foreach($categories as $category)
                                                    <option value="{{$category->id}}" @if($category->id == $childcategory->category_id) selected @endif>{{$category->title}}</option>
                                                @endforeach
                            ...
                            <div class="form-group">
                                <input type="submit"  value="Save Changes" class="btn btn-teal btn-block mg-b-10">
                             </div>
