                                              ...
                                              <div class="modal fade" id="edit{{ $user->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-lg-6">
                                                            <label class="font-weight-bold text-dark text-2">Full Name fffff</label>
                                                    ...
                                                    <div class="form-row">
                                                      ...
                                                      <div class="form-row ">
                                                        <div class="form-group col-lg-6">
                                                            <label class="font-weight-bold text-dark text-2">Start Time[optional]</label>
                                                            <input type="text" value="{{ $user->start_time }}" name="start_time" class="form-control form-control-lg" required="required" >
                                                        </div>
                                                        <div class="form-group col-lg-6">
                                                            <label class="font-weight-bold text-dark text-2">End Time[optional]</label>
                                                            <input type="text" value="{{ $user->end_time }}" name="end_time" class="form-control form-control-lg" required="required" >
                                                        </div>
