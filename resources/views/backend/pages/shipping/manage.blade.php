                    ...
                    <div class="card-block pd-5" style="background-color: #e9ecef;border: 1px solid lightgrey;">
                        <div class="row pb-3">
                            <div class="col-md-1 mr-5">
                                <a href="{{ route('shipping.create')}}" class="btn btn-success ">Add Shipping</a>
                            </div>
            ...
            <div class="br-pagebody" >
                      ...
                      <div class="row" >
                                    ...
                                    <table class="table mg-b-0 table-bordered table-striped" >
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>{{ $shipping ->type }}</td>
                                          <td>{{ $shipping ->text }}</td>
                                          <td>{{$settings->currency ?? "৳"}} {{ $shipping ->amount }}</td>
                        ...
                        <td class="action-button">
                          ...
                          <ul>
                              <li><a href="{{route('shipping.edit', $shipping->id)}}"><i class="fa-solid fa-pen-to-square tx-18"></i></a></li>

                              <li><a href="" data-toggle="modal" data-target="#delete{{$shipping->id}}"><i class="text-danger fa-solid fa-delete-left tx-18"></i></a></li>
                          </ul>
