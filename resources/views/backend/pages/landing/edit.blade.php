            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card bd-0 pd-10 overflow-hidden">
                        <form action="{{ route('landing.update', $landing->id) }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                            ...
                                            <select name="product_id" required="required" class="form-control select2">
                                                ...
                                                @foreach ($products as $product)
                                                    <option value="{{ $product->id }}"
                                                        @if ($landing->product_id == $product->id) selected @endif>
                                                        {{ $product->name }} </option>
                                                @endforeach
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                            <input type="text" name="heading" class="form-control" autocomplete="off"
                                                required="required" placeholder="" value="{{ $landing->heading }}">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                            <input type="text" name="subheading" class="form-control" autocomplete="off"
                                                placeholder="" value="{{ $landing->subheading }}">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                            <input type="text" name="heading_middle" class="form-control"
                                                autocomplete="off" placeholder="" value="{{ $landing->heading_middle }}">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                            <input type="text" name="slider_title" class="form-control"
                                                autocomplete="off" placeholder="" value="{{ $landing->slider_title }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row mt-3 d-none">
                                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                            <input type="number" name="old_price" class="form-control" autocomplete="off"
                                                placeholder="" value="{{ $landing->old_price }}">
                                        </div>
                                    </div>
                                    <div class="row mt-3 d-none">
                                        ...
                                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                            <input type="number" name="home_delivery" class="form-control"
                                                autocomplete="off" placeholder="" value="{{ $landing->home_delivery }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                            <input type="text" name="gallery_title" class="form-control"
                                                autocomplete="off" placeholder="" value="{{ $landing->gallery_title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                            <input type="text" name="testimonial_title" class="form-control"
                                                ...
                                                value="{{ $landing->testimonial_title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                            <select name="status" class="form-control">
                                                ...
                                                <option value="1"@if ($landing->status == 1) selected @endif>
                                                    Published</option>
                                                <option value="0"@if ($landing->status == 0) selected @endif>
                                                    Unpublished</option>
                                            </select>
                                        </div>
                                    </div>
