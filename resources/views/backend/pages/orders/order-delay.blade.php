            ...
            <div class="card-body">
                <div class="row align-items-end">
                    <div class="mb-3 col-lg-4 mb-lg-0">
                        <h4 class="mb-1">Delayed Orders</h4>
                        <p class="mb-0 text-muted">
                            Orders sent to courier but not yet delivered or returned for at least
                            {{ $days }} days.
                        </p>
                    </div>
                    <div class="mb-3 col-lg-3 mb-lg-0">
                        <form method="GET" action="{{ route('order.orderDelay') }}">
                    ...
                    <div class="mb-3 col-lg-3 mb-lg-0">
                        <form method="GET" action="{{ route('order.orderDelay') }}" class="form-inline">
                ...
                <div class="table-responsive">
                    <table class="table mb-0 table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="13" class="text-center text-danger">No delayed orders found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
