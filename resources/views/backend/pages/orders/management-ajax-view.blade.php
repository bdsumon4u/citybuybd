                        ...
                        <div class="dropdown-menu">
                            ...
                            @if ($isLockedOrder)
                                <a class="dropdown-item text-warning"
                                    href="{{ route('order.edit', $order->id) }}">Use edit page with secret key</a>
                            @else
                                @if ($order->status != 1)
                ...
                <td>
                    <div class="mt-1 list-group">
                        <div class="list-group-item align-items-center justify-content-start">
                            ...
                            <div class="">
                                <a href="" data-toggle="modal" data-target="#assign{{ $order->id }}"
                                    class="btn btn-outline-primary btn-icon">
                                    <div class="tx-10"><i class="fa-solid fa-pen-to-square tx-14"></i></div>
                                </a>
                            </div>
                    ...
                    <!-- assign modaal start -->
                    <div class="modal fade" id="assign{{ $order->id }}" tabindex="-1"
                      ...
                      @csrf -->
                                            ...
                                            <select name="order_assign" id="order_assign_{{ $order->id }}"
                                                class="form-control">
                                                @foreach ($users as $user)
                                                    <option value="{{ $user->id }}"
                                                        @if ($user->id == $order->order_assign) selected @endif>
                                                        {{ $user->name }}</option>
                                                @endforeach
