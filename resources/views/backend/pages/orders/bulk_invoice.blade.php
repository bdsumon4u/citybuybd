...
<head>
    ...
    <title>Invoice</title>
    <style>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">@media print {
            body {
                zoom: 75%;
            }
                        ...
                        <div style="text-align: center;">
                            @php
                                ...
                                if (
                                    ...
                                    $manualType = \App\Models\ManualOrderType::where(
                                        'name',
                                        $item->order_type,
                                    )->first();
                            ...
                            @foreach (App\Models\Cart::where('order_id', $item->id)->get() as $cart)
                                <tr style="vertical-align: top">
                                    ...
                                    <td style="text-align: center;width: 5%">
                                        ...
                                        <img src=" {{ asset('backend/img/products/' . $cart->product->image) }}"
                                            width="30">
