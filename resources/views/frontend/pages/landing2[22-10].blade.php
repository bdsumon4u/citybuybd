            ...
            <div class="container">
                <div class="row">
                 ...
                 <!--       </video>-->
                             ...
                             <video width="1240" height="360" controls autoplay muted class="appl1-hdvd-xx">
                        <source src="{{ asset('public/backend/img/landing/' . $landing->video) }}" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>               
...
@endif
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-md-4 top_div offset-md-2 offset-sm-1">
                                 ...
                                 <label style="font-size: 17px;float: left;color: white;margin-left: 25px;">Regular Price:</label> 
                                  ...
                                  <h3 style="float: left;margin-top: 5%;font-weight: 700;font-size: 40px;color: white;"><del>{{ $landing->old_price }}</del>Tk</h3> 
                                    <div class="shape">
                                ...
                                <div class="col-md-4 another_div">
                                  ...
                                  <h3 style="float: left;margin-top: 5%;font-weight: 700;font-size: 40px;color: green;">{{ $landing->new_price }}Tk</h3> 
                                        ...
                                        <div class="address-col">
                                            ...
                                            <div class="billing-fields">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" value="{{ $landing->product->id }}" name="prd_id" class="form-control">
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <input type="hidden" name="product_id" value="{{$landing->product->id}}">
                                                     <input type="hidden" name="price" value="{{$landing->new_price}}">
                                                     <input type="hidden" name="sub_total" value="{{$landing->new_price}}">
        ...
        <select required name="shipping_method" style="min-height: 30px !important;" onchange="getCharge()" id="delivery_charge_id" class="form-control" style="font-size:12px !important;">
                                          ...
                                          @foreach($shippings as $shipping)
                                                <option value="{{ $shipping->id}}" id="charge" data-charge="{{ $shipping->amount}}">{{ $shipping->type }}</option>
                                          @endforeach
                                        </select>
                                                </div>
                                            ...
                                            <table class="shop_table review-order-table">
                                                ...
                                                <tbody>
                                                    <tr class="cart_item">
                                                        ...
                                                        <input type="hidden" id="price_val" value="  {{$landing->new_price}}">
