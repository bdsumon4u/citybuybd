...
@section('body-content')
    ...
    @endif-->
                            ...
                            <div class="img-box" id="bigPreview">
                                ...
                                <img src="{{ asset('backend/img/products/' . $product->image) }}" alt="Image"
                                    class="w-100">
                            ...
                            <form action="{{ route('o_cart.store', $product->id) }}" method="POST">
                                    ...
                                    @if ($product->atr_item != null)
                                        @foreach (App\Models\ProductAttribute::whereIn('id', explode('"', $product->atr))->get() as $b)
                                            <div class="col-lg-3 col-md-4 col-sm-4 col-4">
                                                ...
                                                <select name="attribute[{{ $b->id }}]" id=""
                                                    class="select wide attribute_item_id">
                                ...
                                <div class="btn-box mt-md-3 d-none d-md-flex align-items-center">
                                    ...
                                    @if ($settings->contact_phone_plus == 'whatsapp' || $settings->contact_phone_plus == 'both')
                                        ...
                                        @endphp
                                        <a href="https://wa.me/{{ $phoneTwoNumber }}" target="_blank" class="me-3">
                                            <img src="https://cdn-icons-png.flaticon.com/512/733/733585.png"
                                                alt="WhatsApp" style="width:22px;height:22px;margin-right:6px;">
    ...
    @endif -->
                                ...
                                <div class="p-1 mt-3 text-center border rounded payment-info">
                                    @if ($product->shipping == 1)
                                        <p class="mb-0 text-success" style="font-weight:900;color: #e94b29 !important;">
                                            <i class="fa fa-check-circle me-2"></i> ফ্রি ডেলিভারি চার্জে অর্ডার করুন
                                        </p>
                                    @endif
                                    <p class="mb-0 text-success" style="font-weight:600;">
                                        <i class="fa fa-check-circle me-2"></i> ১০০% শিউর না হয়ে অহেতুক অর্ডার করবেন না
                                    </p>
                                    <p class="mb-0 text-success" style="font-weight:600;">
    ...
    @endif -->
                            ...
                            <div class="product-share">
                                ...
                                <div class="social">
                                    ...
                                    <a href="{{ $settings->youtube_link }}"><i class="fa-brands fa-youtube"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel details-area">
                    <nav>
                        <div class="nav" id="nav-tab" role="tablist">
                            <button class="nav-link active" id="nav-dscr-tab" data-bs-toggle="tab"
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-dscr" role="tabpanel"
                            aria-labelledby="nav-dscr-tab" tabindex="0">
                            <div class="product-dscr">
                                @if (!is_null($product->video))
                                    <video width="350" controls>
                                        <source src="{{ asset('backend/img/products/video/' . $product->video) }}"
                                            type="video/mp4">
                                    </video>
                                @endif
        ...
        <div class="container">
            <div class="panel panel-shadow">
                ...
                <div class="panel-body">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-sweatshirts" role="tabpanel"
                            aria-labelledby="nav-sweatshirts-tab" tabindex="0">
                            <div class="row">
                                    ...
                                    <div class="col-md-2 col-6">
                                        <div class="mb-3 single-product-card">
                                            <div class="part-img">
                                                @if (!is_null($product->offer_price))
                                                    <span class="off-tag"
                                                        style="background-color: #{{ $settings->website_color }}">
                                            ...
                                            <div class="part-txt">
                                                ...
                                                <form action="{{ route('o_cart.store', $product->id) }}" method="POST">
                                                    ...
                                                    <button type="submit" class="btn btn-sm order-btn order_now_btn"><i
                                                            class="fa-solid fa-cart-shopping"> </i> অর্ডার করুন</button>
                                                </form>
