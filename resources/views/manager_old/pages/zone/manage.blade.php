                    ...
                    <div class="card-block pd-5" style="background-color: #e9ecef;border: 1px solid lightgrey;">
                        <div class="row pb-3">
                            <div class="col-md-1 mr-5">
                                <a href="{{ route('manager.zone.create')}}" class="btn btn-success ">Add zone</a>
                            </div>
                            ...
                            @foreach( $zones as $zone )
                                <tr>
                                    ...
                                    <td class="action-button">
                                        ...
                                        <ul>
                                            <li><a href="{{route('manager.zone.edit', $zone->id)}}"><i class="fa-solid fa-pen-to-square tx-18"></i></a></li>

                                            <li><a href="" data-toggle="modal" data-target="#delete{{$zone->id}}"><i class="text-danger fa-solid fa-delete-left tx-18"></i></a></li>
                                        </ul>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('manager.zone.destroy', $zone->id)}}" method="POST">
                                                            @csrf
