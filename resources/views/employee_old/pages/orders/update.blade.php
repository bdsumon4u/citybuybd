                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="br-section-wrapper" style="padding: 10px !important;">
                            <div class="col-md-4">
                                <a href="{{ route('employee.order.manage') }}" class="btn btn-sm btn-info w-25"><i
                            ...
                            <div class="card" data-select2-id="11">
                                ...
                                <div class="card-body" data-select2-id="10">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-12 redx_weight" style="@if(old('courier',$order->courier) != 1) display:none @endif" >
                           ...
                           <div class="form-group col-md-6 col-12 redx_weight d-none" >
                                ...
                                @enderror
                                    ...
                                    <div class="pathao-courier  " style=" @if($order->courier !=3) display: none @endif">
                            ...
                            <div class="form-row">
                                ...
                                @error('pathao_area_id')
                                    ...
                                    <option value="10" {{ $order->status==10 ? 'selected' : '' }}>No Response 3</option>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row" style="padding: 6px 0;">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" class="form-control shipping" id="shipping_cost"
                                    ...
                                    <div class="form-group row" style="padding: 6px 0;">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" class="form-control pay" id="discount"
                                    ...
                                    <div class="form-group row" style="padding: 6px 0;">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" value="{{ $order->pay }}"
