                ...
                <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                    <div class="card-block pd-5" style="background-color: #e9ecef;border: 1px solid lightgrey;">
                        <div class="row  py-2">
                            ...
                            <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['processing'])}}">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal py-1">
                                                <div>
                             ...
                             <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['pending'])}} ">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal "py-1>
                                                <div>
                            ...
                            <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['ondelivery'])}}">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal py-1">
                                                <div>
                        ...
                        <div class="row py-2">
                            <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['pending_p'])}}">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal py-1">
                                                <div>
                            ...
                            <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['hold'])}}">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal py-1">
                                                <div>
                            ...
                            <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['courier_hold'])}}">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal py-1">
                                                <div>
                            ...
                            <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['noresponse1'])}}">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal py-1">
                                                <div>
                        ...
                        <div class="row py-2">
                            <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['noresponse2'])}}">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal py-1">
                                                <div>
                            ...
                            <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['cancel'])}}">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal py-1">
                                                <div>
                            ...
                            <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['return'])}}">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal py-1">
                                                <div>
                             ...
                             <div class="col-lg-3 col-6 pb-1">
                                <a href="{{route('employee.order.management',['completed'])}}">
                                    <div class="card shadow-base bd-0  rounded-right">
                                        <div class="row no-gutters">
                                            <div class="col-md-2 tx-center d-flex align-items-center justify-content-center btn-teal py-1">
                                                <div>
